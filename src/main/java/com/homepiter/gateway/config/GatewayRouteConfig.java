...
public class GatewayRouteConfig {
    ...
    private final com.homepiter.gateway.security.JwtAuthFilter jwtAuthFilter;

    public GatewayRouteConfig(com.homepiter.gateway.security.JwtAuthFilter jwtAuthFilter) {
    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
                ...
                .route("user-service", r -> r.path("/api/users/**")
                        .filters(f -> f.filter(jwtAuthFilter.apply(new com.homepiter.gateway.security.JwtAuthFilter.Config())))
                        .uri("lb://USER-SERVICE"))
